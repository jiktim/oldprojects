...
if (e.message.content == prefix + "hello") {
  ...
  e.message.channel.sendMessage("My youtube: https://www.youtube.com/channel/UC6D_Ee3rLteOhGe-qD0Ku3A");
	...
	}else if (e.message.content == "Ninjacat") {
    e.message.channel.sendMessage("Winsider! https://techfanland-resources.000webhostapp.com/bot%20resources/win10NinjaCat.gif")
	
	}else if (e.message.content == "Winsider") {
    e.message.channel.sendMessage("Ninjacat! https://techfanland-resources.000webhostapp.com/bot%20resources/win10NinjaCat.gif")
	
	}else if (e.message.content == "Windoge 10") {
    e.message.channel.sendMessage("https://techfanland-resources.000webhostapp.com/bot%20resources/Windoge_10.jpg")
	
	
	}else if (e.message.content == "Winsider") {
    e.message.channel.sendMessage("Julia is the craziest Winsider that uses Winsider everyday LOL!")
    ...
    e.message.channel.sendMessage("Oh no, not this again!")
	}else if (e.message.content == ".net framework") {
    e.message.channel.sendMessage("Oh no, not this again!")
	...
	}else if (e.message.content == "Should I rd?") {
    e.message.channel.sendMessage("Not unless it is a VM.")
	}else if (e.message.content == "Should I run MEMZ on my host?") {
    e.message.channel.sendMessage("NOOOOOOOO unless you really want to reinstall WIndows..")
